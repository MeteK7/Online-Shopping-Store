...
namespace OnlineShoppingStore.Repository
{
    public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        ...
        private dbOnlineShoppingEntities _DBEntity;
        ...
        public IEnumerable<Tbl_Entity> GetRecordsToShow(int PageNo, int PageSize, int CurrentPage, Expression<Func<Tbl_Entity, bool>> wherePedict, Expression<Func<Tbl_Entity, int>> orderByPredict)
        {
            if (wherePedict != null)
            {
